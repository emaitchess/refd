...
export const DitherButton = ({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "relative isolate overflow-hidden rounded-md px-4 py-2 font-mono text-xs text-foreground transition-opacity disabled:pointer-events-none disabled:opacity-40",
        className
      )}
      {...props}
    >

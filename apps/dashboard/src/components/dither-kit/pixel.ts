...
export const hueFill = (hue: number): Rgb => {
...
export const fillOf = (color: PixelColor): Rgb =>
  typeof color === "number" ? hueFill(color) : PALETTE[color].fill
...
export const pixelBloomStyle = (bloom: PixelBloom): PixelBloomStyle | null => {
...
export const pixelPrefersReducedMotion = (): boolean =>

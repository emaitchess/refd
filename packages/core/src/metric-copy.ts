...
export const METRIC_INFO = {
  ...
  materialChange: {
    ...
    category: 'Changes',
    definition:
      'A movement between the two most recent completed runs large enough to outrank routine run-to-run noise: 15 points for mention and citation rates, 10 points for share of voice, 20 points for sentiment shares, and one full rank for average position.',
    details:

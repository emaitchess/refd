...
const CartesianSeries = ({
  ...
  // Both continuous kinds may mix under either root: the shared canvas
  // paints per-series kind (brand area + competitor lines on one chart).
  const ctx = useChartPart(part, ["line", "area"])
...
export const Line = (props: AreaProps) => {

...
export const buildXScale = (length: number, plotWidth: number) => {
...
export const buildBandScale = (length: number, plotWidth: number) => {
...
export const indexAtBand = (px: number, length: number, plotWidth: number) => {
...
export const buildYScale = (max: number, plotHeight: number) => {
...
export const nearestIndex = (px: number, length: number, plotWidth: number) => {

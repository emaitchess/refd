...
// Top-right account control: an initial chip that opens the session info + sign
// out. Closes on outside click (invisible backdrop) or Escape. `className` sizes
// the chip to whatever it sits beside (twMerge lets a size-* override win).
      ...
      {open ? (
        <>
          ...
          {/* Padding lives on the rows, not the panel, so the session block and
              the action share one left edge and the divider spans full width. */}
